export interface NotificationOptions {
  ...
  export function showNotification(options: NotificationOptions = {}) {
    ...
    button.className = 'w-full py-2 px-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all';
    ...
    popup.classList.add('transform', 'transition-all', 'duration-300', 'scale-95', 'opacity-0');
    setTimeout(() => {
